...
<div class="view">
	<div state="{{currentPage}}" class="panels">
		...
		<div class="panel"> <?php include("pages/admin/groupes.php"); ?>
		</div>
		<div class="panel"> <?php include("pages/admin/presentation.php"); ?>
		</div>
		<div class="panel"> 
			<h2>[Page à inclure ici] ~T4</h2>
		</div>
		<div class="panel"><?php include("pages/admin/etudiants.php"); ?>
		</div>
		<div class="panel"><?php include("pages/admin/promos.php") ?>
		</div>
	</div>
</div><?php echo '</div>';
} ?>