...
<div class="page liste-des-projets">
	...
	<div ng-init="nbChoice = 6;" class="projectList">
		...
		<div data-as-sortable="dragControlListeners" data-ng-model="projects" class="body"><a href="/?liste-des-projets/{{project.id | fillZero}}-{{project | getLinkFromTitle}}" target="_blank" included="{{k&lt;nbChoice}}" data-ng-repeat="(k,project) in projects | filter:search" data-as-sortable-item="data-as-sortable-item" class="row">
	...
	<div ng-init="nbChoice = 6;" class="projectList">
		...
		<div data-as-sortable="dragControlListeners" data-ng-model="projects" class="body"><a href="/?liste-des-projets/{{project.id | fillZero}}-{{project | getLinkFromTitle}}" target="_blank" included="false" data-ng-repeat="(k,project) in projects | filter:search" data-as-sortable-item="data-as-sortable-item" class="row">
